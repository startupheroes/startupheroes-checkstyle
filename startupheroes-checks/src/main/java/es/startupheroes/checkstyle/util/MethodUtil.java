...
public final class MethodUtil {
   ...
   public static Boolean isToStringMethod(DetailAST ast) {
      ...
      return getSimpleAndFullNames(ClassUtil.STRING_CLASS_NAME_BY_PACKAGE).contains(type.getFirstChild().getText())
   ...
   private static Boolean isObjectParam(DetailAST paramNode) {
      return getSimpleAndFullNames(ClassUtil.OBJECT_CLASS_NAME_BY_PACKAGE).contains(getParamTypeSimpleName(paramNode));
   }
